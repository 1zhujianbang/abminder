...
新用户把下面这段发给 AI，即可自动完成首次配置：

> 我是一个新用户，第一次使用 abminder 交易信号标注工具。
>
> 1. 帮我启动 `node server.js` 并打开 `http://localhost:3456`
> 2. 询问我要交易的市场（加密市场 / 美股 / A股）和具体标的
> 3. 根据我的选择，帮我配置设置面板中的默认交易对和周期
> 4. 如果需要邮件通知，请引导我配置 SMTP
> 5. 问清楚我的风险偏好和分析频率，然后设置定时分析任务
>
> 不要预设任何偏好，所有决策让我来选。
